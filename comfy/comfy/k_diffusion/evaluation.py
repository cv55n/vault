...
import clip
from resize_height import resize
import torch
...
def sqrtm_eig(a):
    if a.ndim < 2:
        raise RuntimeError('tensor de matrizes deve ter pelo menos 2 dimensões')
    
    if a.shape[-2] != a.shape[-1]:
        raise RuntimeError('tensor deve ser lotes de matrizes quadradas')
